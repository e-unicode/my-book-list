...
// 서버코드짤때 쓰는 공식: 뭔갈 저장하고싶을때, Object자료형으로 저장
// db.collection('post').insertOne({이름 : 'EUNI', _id : 100, 나이 : 20}, function(에러, 결과) {
//     console.log('저장완료');
// });
...
app.post('/add', function(요청, 응답) {
    ...
    db.collection('counter').findOne({ name : "postCount" }, function(에러, 결과) {
        ...
        db.collection('post').insertOne({ _id : 총게시물갯수 + 1, title : 요청.body.title, artist : 요청.body.artist }, function(에러, 결과) {
            console.log('저장완료');
